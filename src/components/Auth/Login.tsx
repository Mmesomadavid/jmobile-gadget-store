...
export default function Login({ open, onOpenChange }: LoginProps) {
  ...
  }, [location.search, login, navigate, onOpenChange, loading]);
      ...
      <DialogContent className="w-[90vw] sm:max-w-md rounded-2xl p-4 sm:p-6">
        ...
        <div className="mt-6 flex flex-col items-center space-y-4">
          ...
          <Button
            ...
            variant="outline"
            className="w-full flex items-center justify-center gap-3 py-3 sm:py-4 rounded-xl text-sm sm:text-base border border-gray-300 hover:bg-gray-50 transition"
          >
            <svg
          ...
          {/* Terms */}
          <p className="text-center text-xs sm:text-sm text-gray-500 max-w-[90%]">
